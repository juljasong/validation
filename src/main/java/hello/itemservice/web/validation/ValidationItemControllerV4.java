...
public class ValidationItemControllerV4 {
    ...
    @PostMapping("/add")
    public String addItem2(@Validated @ModelAttribute("item") ItemSaveForm itemSaveForm, BindingResult bindingResult,
    ...
    public String edit2(@PathVariable Long itemId, @ModelAttribute("item") ItemUpdateForm itemUpdateForm, BindingResult bindingResult) {
